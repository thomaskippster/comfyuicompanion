...
import de.tki.comfyuicompanion.service.graph.WorkflowBuilder;
...
public class AgenticWorkflowOrchestrator {
    ...
    private final de.tki.comfyuicompanion.service.llm.ILlmRoutingService llmRoutingService;
    ...
    public AgenticWorkflowOrchestrator(de.tki.comfyuicompanion.service.llm.ILlmRoutingService llmRoutingService,
    ...
    public Mono<String> orchestrateAndRun(String userInput) {
        ...
        de.tki.comfyuicompanion.service.provisioning.MissingResourceReport report = gapAnalyzer.analyze(intent);
        ...
        if (hasResolvedModel) {
            ...
            logger.info("Auto-Provisioning: Using best locally available model '{}' for architecture '{}'", finalModelName, intent.getArchitecture());
        } else {
            ...
            logger.info("Auto-Provisioning: No local model found. Fallback name '{}' reserved for download.", finalModelName);
        }
