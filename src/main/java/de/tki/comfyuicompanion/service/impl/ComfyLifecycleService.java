...
public class ComfyLifecycleService implements IComfyLifecycleService {
    ...
    private final de.tki.comfyuicompanion.service.IDownloadManager downloadManager;
    ...
    public ComfyLifecycleService(
            ...
            @Autowired(required = false) @org.springframework.context.annotation.Lazy de.tki.comfyuicompanion.service.IDownloadManager downloadManager) {
    ...
    public synchronized void start() {
        ...
        try {
            ...
            de.tki.comfyuicompanion.domain.LaunchProfile activeProfile = null;
            ...
            if (activeProfile == null) {
                java.util.List<de.tki.comfyuicompanion.domain.LaunchProfile> profiles = profileManager.loadProfiles();
                if (!profiles.isEmpty()) {
            ...
            if (activeProfile != null) {
                ...
                final de.tki.comfyuicompanion.domain.LaunchProfile finalProfile = activeProfile;
                                ...
                                if (configService == null || !configService.isHideComfyUI()) {
                                    ...
                                    try {
                                        if (java.awt.Desktop.isDesktopSupported() && java.awt.Desktop.getDesktop().isSupported(java.awt.Desktop.Action.BROWSE)) {
                                            ...
                                            String cmd = de.tki.comfyuicompanion.util.PlatformUtils.isWindows() ? "cmd /c start " + url : "xdg-open " + url;
    ...
    private void killProcessOnPort() {
        try {
            ...
            if (de.tki.comfyuicompanion.util.PlatformUtils.isWindows()) {
