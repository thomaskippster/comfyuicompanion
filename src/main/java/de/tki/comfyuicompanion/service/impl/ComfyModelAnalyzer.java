...
public class ComfyModelAnalyzer implements IModelAnalyzer {
            ...
            if (jo.has("models") && jo.get("models") instanceof JSONArray ms) {
                for (int i = 0; i < ms.length(); i++) {
                    ...
                    if (m != null) {
                        ...
                        if (n != null && !n.isEmpty()) {
                            String rawPath = m.optString("directory", m.optString("type", de.tki.comfyuicompanion.domain.ModelFolder.CHECKPOINTS.getDefaultFolderName()));
    ...
    private void processVal(String v, String ctx, String hint, List<ModelInfo> res) {
        ...
        while (mdMatcher.find()) {
            ...
            if (name.contains(".")) {
                ...
                if ((type == null || type.equals(de.tki.comfyuicompanion.domain.ModelFolder.CHECKPOINTS.getDefaultFolderName())) && url.contains("/resolve/main/")) {
                ...
                addModelInfo(res, new ModelInfo(type != null ? type : de.tki.comfyuicompanion.domain.ModelFolder.CHECKPOINTS.getDefaultFolderName(), name, url));
            }
        }
        ...
        while (m.find()) {
            ...
            if (f.length() > 3) {
                ...
                if (COMP_VAE_PATTERN.matcher(fLow).find() && (type == null || type.equals(de.tki.comfyuicompanion.domain.ModelFolder.CHECKPOINTS.getDefaultFolderName()))) type = "vae";
                else if (COMP_CLIP_PATTERN.matcher(fLow).find() && (type == null || type.equals(de.tki.comfyuicompanion.domain.ModelFolder.CHECKPOINTS.getDefaultFolderName()))) type = "clip";
                else if (COMP_UNET_PATTERN.matcher(fLow).find() && (type == null || type.equals(de.tki.comfyuicompanion.domain.ModelFolder.CHECKPOINTS.getDefaultFolderName()) || (type.equals("clip") && !fLow.contains("clip_l") && !fLow.contains("clip_g")))) type = "unet";
                
                ModelInfo info = new ModelInfo(type != null ? type : de.tki.comfyuicompanion.domain.ModelFolder.CHECKPOINTS.getDefaultFolderName(), f, "MISSING");
    ...
    private String inferTypeFromNode(String nt) {
        nt = nt.toLowerCase();
        if (nt.contains("checkpoint")) return de.tki.comfyuicompanion.domain.ModelFolder.CHECKPOINTS.getDefaultFolderName();
        if (nt.contains("lora")) return de.tki.comfyuicompanion.domain.ModelFolder.LORAS.getDefaultFolderName();
        if (nt.contains("vae")) return de.tki.comfyuicompanion.domain.ModelFolder.VAE.getDefaultFolderName();
        if (nt.contains("controlnet") || nt.contains("t2i_adapter")) return de.tki.comfyuicompanion.domain.ModelFolder.CONTROLNET.getDefaultFolderName();
        if (nt.contains("upscale") || nt.contains("esrgan")) return de.tki.comfyuicompanion.domain.ModelFolder.UPSCALE_MODELS.getDefaultFolderName();
        if (nt.contains("latent_upscale")) return de.tki.comfyuicompanion.domain.ModelFolder.LATENT_UPSCALE_MODELS.getDefaultFolderName();
        if (nt.contains("clip_vision") || nt.contains("clipvision")) return de.tki.comfyuicompanion.domain.ModelFolder.CLIP_VISION.getDefaultFolderName();
        if (nt.contains("clip") || nt.contains("text_encoder") || nt.contains("tokenizer")) return de.tki.comfyuicompanion.domain.ModelFolder.CLIP.getDefaultFolderName();
        if (nt.contains("diffusion_model")) return de.tki.comfyuicompanion.domain.ModelFolder.DIFFUSION_MODELS.getDefaultFolderName();
        if (nt.contains("unet") || nt.contains("diffusion")) return de.tki.comfyuicompanion.domain.ModelFolder.UNET.getDefaultFolderName();
        if (nt.contains("gligen")) return de.tki.comfyuicompanion.domain.ModelFolder.GLIGEN.getDefaultFolderName();
        if (nt.contains("embeddings") || nt.contains("textual_inversion")) return de.tki.comfyuicompanion.domain.ModelFolder.EMBEDDINGS.getDefaultFolderName();
        if (nt.contains("hypernetwork")) return de.tki.comfyuicompanion.domain.ModelFolder.HYPERNETWORKS.getDefaultFolderName();
        if (nt.contains("photomaker")) return de.tki.comfyuicompanion.domain.ModelFolder.PHOTOMAKER.getDefaultFolderName();
        if (nt.contains("style_model")) return de.tki.comfyuicompanion.domain.ModelFolder.STYLE_MODELS.getDefaultFolderName();
        if (nt.contains("audio") && nt.contains("encoder")) return de.tki.comfyuicompanion.domain.ModelFolder.AUDIO_ENCODERS.getDefaultFolderName();
        if (nt.contains("diffusers")) return de.tki.comfyuicompanion.domain.ModelFolder.DIFFUSERS.getDefaultFolderName();
        if (nt.contains("configs")) return de.tki.comfyuicompanion.domain.ModelFolder.CONFIGS.getDefaultFolderName();
        if (nt.contains("model_patch")) return de.tki.comfyuicompanion.domain.ModelFolder.MODEL_PATCHES.getDefaultFolderName();
        return null;
    }

    private String inferTypeFromKey(String k) {
        k = k.toLowerCase();
        if (k.contains("checkpoint")) return de.tki.comfyuicompanion.domain.ModelFolder.CHECKPOINTS.getDefaultFolderName();
        if (k.contains("lora")) return de.tki.comfyuicompanion.domain.ModelFolder.LORAS.getDefaultFolderName();
        if (k.contains("vae")) return de.tki.comfyuicompanion.domain.ModelFolder.VAE.getDefaultFolderName();
        if (k.contains("clip_vision") || k.contains("clipvision")) return de.tki.comfyuicompanion.domain.ModelFolder.CLIP_VISION.getDefaultFolderName();
        if (k.contains("clip") || k.contains("text_encoder") || k.contains("tokenizer")) return de.tki.comfyuicompanion.domain.ModelFolder.CLIP.getDefaultFolderName();
        if (k.contains("diffusion_model")) return de.tki.comfyuicompanion.domain.ModelFolder.DIFFUSION_MODELS.getDefaultFolderName();
        if (k.contains("unet") || k.contains("diffusion")) return de.tki.comfyuicompanion.domain.ModelFolder.UNET.getDefaultFolderName();
        if (k.contains("control") && k.contains("net")) return de.tki.comfyuicompanion.domain.ModelFolder.CONTROLNET.getDefaultFolderName();
        if (k.contains("upscale") || k.contains("esrgan")) return de.tki.comfyuicompanion.domain.ModelFolder.UPSCALE_MODELS.getDefaultFolderName();
        if (k.contains("embedding")) return de.tki.comfyuicompanion.domain.ModelFolder.EMBEDDINGS.getDefaultFolderName();
        if (k.contains("hypernetwork")) return de.tki.comfyuicompanion.domain.ModelFolder.HYPERNETWORKS.getDefaultFolderName();
        if (k.contains("gligen")) return de.tki.comfyuicompanion.domain.ModelFolder.GLIGEN.getDefaultFolderName();
        if (k.contains("photomaker")) return de.tki.comfyuicompanion.domain.ModelFolder.PHOTOMAKER.getDefaultFolderName();
        if (k.contains("style_model")) return de.tki.comfyuicompanion.domain.ModelFolder.STYLE_MODELS.getDefaultFolderName();
        if (k.contains("audio") && k.contains("encoder")) return de.tki.comfyuicompanion.domain.ModelFolder.AUDIO_ENCODERS.getDefaultFolderName();
        if (k.contains("config")) return de.tki.comfyuicompanion.domain.ModelFolder.CONFIGS.getDefaultFolderName();
        return null;
    }
    ...
    private void addModelInfo(List<ModelInfo> res, ModelInfo info) {
        for (ModelInfo e : res) {
            if (e.getName().equalsIgnoreCase(info.getName())) {
                ...
                if (de.tki.comfyuicompanion.domain.ModelFolder.CHECKPOINTS.getDefaultFolderName().equals(e.getType()) && !de.tki.comfyuicompanion.domain.ModelFolder.CHECKPOINTS.getDefaultFolderName().equals(info.getType())) {
                ...
                if (e.getUrl().equals("MISSING") && !info.getUrl().equals("MISSING")) {
                    ...
                    if (info.getType() != null && !de.tki.comfyuicompanion.domain.ModelFolder.CHECKPOINTS.getDefaultFolderName().equals(info.getType())) {
                        e.setType(info.getType());
                    }
                }
                return;
