...
public class ModelSearchService implements IModelSearchService {
    ...
    private de.tki.comfyuicompanion.service.impl.ModelHashRegistry hashRegistry;
    private de.tki.comfyuicompanion.service.IModelValidator modelValidator;
    ...
    public ModelSearchService(ConfigService configService,
                              ...
                              de.tki.comfyuicompanion.service.impl.ModelHashRegistry hashRegistry,
                              de.tki.comfyuicompanion.service.IModelValidator modelValidator) {
    ...
    private void performSearch(ModelInfo info, int index, String fileName, String workflowContext, boolean manual,
        ...
        java.io.File localFile = new java.io.File(modelsPath, (info.getSave_path() != null ? info.getSave_path() : (info.getType() != null ? info.getType() : de.tki.comfyuicompanion.domain.ModelFolder.CHECKPOINTS.getDefaultFolderName())) + java.io.File.separator + info.getName());
        if (localFile.exists()) {
    ...
    public Optional<ModelInfo> checkForUpdate(ModelInfo current) {
        String modelsPath = configService.getModelsPath();
        String subPath = (current.getSave_path() != null ? current.getSave_path() : (current.getType() != null ? current.getType() : de.tki.comfyuicompanion.domain.ModelFolder.CHECKPOINTS.getDefaultFolderName()));
