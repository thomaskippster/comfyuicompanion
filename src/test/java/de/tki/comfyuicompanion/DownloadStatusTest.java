...
import de.tki.comfyuicompanion.service.impl.DefaultDownloadManager;
import de.tki.comfyuicompanion.service.impl.EncryptionUtils;
...
public class DownloadStatusTest {
    ...
    public void setup() throws Exception {
        ...
        downloadManager = new DefaultDownloadManager(
                new ConfigService(new EncryptionUtils(), new de.tki.comfyuicompanion.service.impl.PathResolver()),
                new de.tki.comfyuicompanion.service.impl.PathResolver(), null, null, null);
