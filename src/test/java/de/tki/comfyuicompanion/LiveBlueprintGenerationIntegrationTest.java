...
public class LiveBlueprintGenerationIntegrationTest {
    ...
    void testLiveSceneGeneration_VideoArchitect() throws Exception {
        ...
        de.tki.comfyuicompanion.service.impl.ConfigService configService = org.mockito.Mockito.mock(de.tki.comfyuicompanion.service.impl.ConfigService.class);
        ...
        try {
            ...
            f1.set(pipelineService, new de.tki.comfyuicompanion.service.impl.ProcessTracker());
