...
class ComfyCompanionControllerTest {
    ...
    @Mock
    private de.tki.comfyuicompanion.service.inspector.TriggerWordService triggerWordService;

    @Mock
    private de.tki.comfyuicompanion.service.provisioning.CustomNodeResolverService customNodeResolverService;
    ...
    void shouldReturnModelMetadataWhenFound() {
        var info = new de.tki.comfyuicompanion.service.inspector.TriggerWordService.ModelTriggerInfo(
    ...
    void shouldAnalyzeWorkflowNodesSuccessfully() {
        ...
        var report = new de.tki.comfyuicompanion.service.provisioning.CustomNodeResolverService.NodeResolutionReport(
                java.util.Set.of("FaceDetailer"),
                java.util.Set.of("FaceDetailer"),
                java.util.List.of(new de.tki.comfyuicompanion.service.provisioning.CustomNodeResolverService.CustomNodePackage(
