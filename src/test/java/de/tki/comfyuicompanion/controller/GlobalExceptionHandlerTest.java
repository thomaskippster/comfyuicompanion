...
import de.tki.comfyuicompanion.dto.ApiErrorResponse;
...
class GlobalExceptionHandlerTest {
    ...
    void shouldHandleIllegalArgumentException() {
        ...
        IllegalArgumentException ex = new IllegalArgumentException("Prompt must not be empty.");
        ...
        assertThat(body.message()).isEqualTo("Prompt must not be empty.");
    ...
    void shouldHandleGenericException() {
        ...
        assertThat(body.message()).isEqualTo("An internal server error occurred.");
