...
public class LocalTTSServiceQwenTest {
    ...
    public void defaultProviderIsQwenTts() {
        ...
        assertEquals("ComfyUI Qwen-TTS", new ConfigService(null, new de.tki.comfyuicompanion.service.impl.PathResolver()).getTtsProvider());
    }

    @Test
    public void qwenConfigDefaults_areReasonable() {
        ConfigService fresh = new ConfigService(null, new de.tki.comfyuicompanion.service.impl.PathResolver());
    ...
    public void qwenConfigSetters_roundTrip() {
        ...
        ConfigService realConfig = new ConfigService(null, new de.tki.comfyuicompanion.service.impl.PathResolver()) {
            @Override
