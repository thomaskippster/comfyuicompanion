...
import de.tki.comfyuicompanion.service.impl.ComfyRegistryClient;
import de.tki.comfyuicompanion.service.impl.ConfigService;
import de.tki.comfyuicompanion.service.impl.LocalModelScanner;
import de.tki.comfyuicompanion.service.impl.LocalModelValidator;
...
public class BlueprintGalleryTabTest {
    ...
    @Mock private de.tki.comfyuicompanion.service.impl.LocalAIService localAIService;
    @Mock private ProcessTracker processTracker;
    @Mock private de.tki.comfyuicompanion.service.IModelSearchService modelSearchService;
    ...
    public void testRealDataLoading() throws Exception {
        ...
        while (System.currentTimeMillis() - start < 15000) {
            Thread.sleep(500);
            if (de.tki.comfyuicompanion.ui.BlueprintGalleryTabTestHelper.getGalleryWrapper(blueprintGalleryTab).getComponents().length > 0) {
                // If components are added, we are loaded!
                break;
            }
        }
        
        JPanel galleryWrapper = de.tki.comfyuicompanion.ui.BlueprintGalleryTabTestHelper.getGalleryWrapper(blueprintGalleryTab);
        
        // Force size so columns calculate
        galleryWrapper.setSize(1200, 800);
        
        SwingUtilities.invokeAndWait(() -> {
            de.tki.comfyuicompanion.ui.BlueprintGalleryTabTestHelper.applyFilter(blueprintGalleryTab);
        });
