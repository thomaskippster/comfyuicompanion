...
import de.tki.comfyuicompanion.Main;
...
public class GuiStatusTransitionTest {
    ...
    public void setUp() throws InterruptedException, InvocationTargetException {
        ...
        SwingUtilities.invokeAndWait(() -> {
            ...
            de.tki.comfyuicompanion.util.BackgroundExecutor bgExec = new de.tki.comfyuicompanion.util.BackgroundExecutor();
            DownloadManagerView dmView = new DownloadManagerView();
            de.tki.comfyuicompanion.controller.DownloadManagerController dmController = new de.tki.comfyuicompanion.controller.DownloadManagerController(
            ...
            ReflectionTestUtils.setField(mainFrame, "processTracker", new de.tki.comfyuicompanion.service.impl.ProcessTracker());
